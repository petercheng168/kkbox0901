...
namespace SeleniumTests
{
    ...
    public class Dislike
    {
        ...
        public void TheDislikeTest()
        {
            ...
            driver.FindElement(By.Name("nickName")).SendKeys("0933751972");
            driver.FindElement(By.Name("password")).Clear();
            driver.FindElement(By.Name("password")).SendKeys("peter528");
            driver.FindElement(By.Id("login-btn")).Click();
            driver.FindElement(By.LinkText("電台")).Click();
            driver.FindElement(By.CssSelector("a.btn-radio")).Click();
